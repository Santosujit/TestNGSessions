...
public class TestCaseDesign {
	...
	/*
	 * BS -- Connect with DB BT -- Create a sample User in DB BC -- Launch the
	 * browser and APP
	 * 
	 * BM -- Login to app user info test -- t1 AM -- logout
	 * 
	 * BM -- Login to app home page search test -- t2 AM -- logout
	 * 
	 * BM -- Login to app home page title test --t3 AM -- logout
	 * 
	 * AC -- close the browser AT -- Delete the user in DB AS -- disconnect from DB
	 */
